 ...
 * If you are not building a DLL, you can save a little stack activity
 * (with a slightly larger executable) by using global arrays.
 */
...
#  if defined(_MSC_VER) && defined(_USRDLL) && !defined(BUILD_BMG_DLL)
