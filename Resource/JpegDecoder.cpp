...
Texture * decodeJpeg ( jpeg_decompress_struct * cinfo );
...
MetaClass	JpegDecoder :: classInstance ( "JpegDecoder", &ResourceDecoder :: classInstance );

bool	JpegDecoder :: checkExtension ( const String& theName )
{
...
Object * JpegDecoder :: decode ( Data * data )
{
	...
	Texture * texture = new Texture ( "", width, height, isGreyScale ? monoFormat : rgbFormat );
	...
	while ( cinfo.output_scanline < cinfo.output_height )
	{
		...
		texture -> writeLine ( height - 1 - y, lineBuf );
